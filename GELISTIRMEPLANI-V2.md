...
- [ ] **TMDB atfı**: "This product uses the TMDB API but is not endorsed or certified by TMDB" metni + logo, ayarlar/hakkında ekranına (API kullanım koşulu; JustWatch atfı detay ekranında zaten mevcut).
- [ ] **Sürüm modeli kararının kaydı**: v1 tamamen ücretsiz; ücretli katman değerlendirmesi Faz G'de, kullanım verisi görüldükten sonra. Karar burada kayıt altında — v1 kapsamında tekrar tartışılmaz.
